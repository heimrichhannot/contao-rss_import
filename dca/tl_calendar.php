...
// Selectors
$GLOBALS['TL_DCA']['tl_calendar']['palettes']['__selector__'][]= 'rssimp_imp';

// Subpalettes 
$GLOBALS['TL_DCA']['tl_calendar']['subpalettes']['rssimp_imp']= 
...
$tmpfields= array
	(
       'rssimp_imp' => array 
        ( 
			'label'                 => &$GLOBALS['TL_LANG']['tl_calendar']['rssimp_imp'],
            'inputType'             => 'checkbox',
			'exclude'               => true,         
            'default'               => '', 
		...
		(
			'label'                 => &$GLOBALS['TL_LANG']['tl_calendar']['rssimp_published'],
			'exclude'               => true,
			'filter'                => true,
			'flag'                  => 1,
			'inputType'             => 'checkbox',
...
//			'eval'                  => array('mandatory'=>false, 'tl_class'=>'w50', 'includeBlankOption' => true),
		...
		(
			'label'                 => &$GLOBALS['TL_LANG']['tl_calendar']['rssimp_teaserhtml'],
			'exclude'               => true,
			'filter'                => true,
			'flag'                  => 1,
			'inputType'             => 'checkbox',
		...
		(
			'label'                 => &$GLOBALS['TL_LANG']['tl_calendar']['rssimp_allowedTags'],
			'exclude'               => true,
			'inputType'             => 'text',
...
$GLOBALS['TL_DCA']['tl_calendar']['fields']= array_merge($GLOBALS['TL_DCA']['tl_calendar']['fields'],$tmpfields);